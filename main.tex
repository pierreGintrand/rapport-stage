...
\usepackage[notmath]{sansmathfonts} % enable sf for small caps
...
Quand j'ai quitter l'équipe, le projet était extrêmement avancé. Le principal problème qui persistait était la dissipation de la chaleur émise par le panneau de LEDs et par le PCB. 
...
Ce stage a été ma 1\ieme{} expérience de longue durée en entreprise. Après mon installation et mon acclimatation qui ont duré environ 3 semaines, j'ai su me servir de mes connaissances et surtout 

Ma mission étant de programmer les microprocesseurs présents sur les circuits, j'ai
% elecambarqué: 
