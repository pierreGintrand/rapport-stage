...
\end{center}
\caption{Définition de pins sur le processeur EFM8BB1x-QSOP24} 
...
\end{center}
\caption{Algorithme de charge d’une batterie lithium-ion} 
