...
Je tiens à remercier David \bsc{Collardeau}, Jean \bsc{Weber} et Guillaume \bsc{Baradel} pour m’avoir accueilli dans leur entreprise et pour la confiance qu'ils m'ont accordé tout au long du stage.
...
Mon stage s’est déroulé dans le pôle recherche et développement de Neohm, sous la direction de David \bsc{Collardeau}. Au départ nous étions 4 à travailler dans ces bureaux : David, Sy et Green et moi. Jean venait dans les bureaux environs une fois toutes les 2 semaines pour faire un point sur l'avancement et préparer au mieux l'industrialisation du produit. Plus tard, 2 nouveaux collaborateurs se sont joints à l’équipe.
